...
namespace FluentMigrator.Tests.Integration.Processors.Snowflake
{
    ...
    public class SnowflakeColumnTests : BaseColumnTests
    {
        ...
        public override void CallingColumnExistsCanAcceptColumnNameWithSingleQuote()
        {
            ...
            SnowflakeTestTable TableCreationFunc() => new SnowflakeTestTable(Processor, TestSchema, columnNameWithSingleQuote + " int");

            if (_quotingEnabled)
            {
                using (var table = TableCreationFunc())
                    Processor.ColumnExists(TestSchema, table.Name, "i'd").ShouldBeTrue();
            }
            else
            {
        ...
        {
            SnowflakeTestTable TableCreationFunc() => new SnowflakeTestTable(
                "Test'Table",
                Processor,
                TestSchema,
                $"{Quoter.Quote("id")} int");
