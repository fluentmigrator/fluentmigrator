...
namespace FluentMigrator.Tests.Integration.Processors.SqlServer
{
    ...
    public class SqlServerSequenceTests : BaseSequenceTests
    {
        ...
        public void SetUp()
        {
            ...
            Processor = new SqlServerProcessor(Connection, new SqlServer2012Generator(), new TextWriterAnnouncer(TestContext.Out), new ProcessorOptions(), new SqlServerDbFactory());
            Connection.Open();
