...
namespace FluentMigrator.Runner.Generators.SQLite
{
    ...
    public class SQLite2Generator : GenericGenerator
    {
        public SQLite2Generator()
            : this(new SQLite2Quoter())
        {
        }

        public SQLite2Generator(
            [NotNull] SQLite2Quoter quoter)
        ...
        public SQLite2Generator(
            ...
            : base(new SQLite2Column(), quoter, new EmptyDescriptionGenerator(), generatorOptions)
        {
        }
