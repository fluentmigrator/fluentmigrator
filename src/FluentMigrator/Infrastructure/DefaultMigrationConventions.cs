...
namespace FluentMigrator.Infrastructure
{
    public static class DefaultMigrationConventions
    {
        ...
        public static IMigrationInfo GetMigrationInfoFor(Type migrationType)
        {
            ...
            var migrationInfo = new MigrationInfo(migrationAttribute.Version, migrationAttribute.Description, migrationAttribute.TransactionBehavior, migrationFunc, migrationAttribute.DependsOn);
