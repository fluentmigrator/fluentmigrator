...
namespace FluentMigrator.Infrastructure
{
    public class MigrationContext : IMigrationContext
    {
        ...
        public virtual IAssemblyCollection MigrationAssembly { get; set; }
        ...
        public MigrationContext(IMigrationConventions conventions, IQuerySchema querySchema, IAssemblyCollection migrationAssembly, object context, string connection)
        {
