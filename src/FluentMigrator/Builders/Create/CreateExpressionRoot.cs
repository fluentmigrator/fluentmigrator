...
namespace FluentMigrator.Builders.Create
{
    public class CreateExpressionRoot : ICreateExpressionRoot
    {
        ...
        {
            var expression = new CreateTableExpression { TableName = tableName, CheckIfExists = _context.CheckIfExists };
            _context.Expressions.Add(expression);
        ...
        {
            var expression = new CreateColumnExpression { Column = { Name = columnName }, CheckIfExists = _context.CheckIfExists };
            _context.Expressions.Add(expression);
        ...
        {
            var expression = new CreateForeignKeyExpression { CheckIfExists = _context.CheckIfExists };
            _context.Expressions.Add(expression);
        ...
        {
            var expression = new CreateForeignKeyExpression { ForeignKey = { Name = foreignKeyName }, CheckIfExists = _context.CheckIfExists };
            _context.Expressions.Add(expression);
            return new CreateForeignKeyExpressionBuilder(expression);
        }
        ...
        {
            var expression = new CreateIndexExpression { CheckIfExists = _context.CheckIfExists };
            _context.Expressions.Add(expression);
        ...
        {
            var expression = new CreateIndexExpression { Index = { Name = indexName }, CheckIfExists = _context.CheckIfExists };
            _context.Expressions.Add(expression);
            return new CreateIndexExpressionBuilder(expression);
        }
        ...
        {
            var expression = new CreateSequenceExpression { Sequence = { Name = sequenceName }, CheckIfExists = _context.CheckIfExists };
            _context.Expressions.Add(expression);
        ...
        {
            var expression = new CreateConstraintExpression(ConstraintType.Unique) { CheckIfExists = _context.CheckIfExists };
            _context.Expressions.Add(expression);
        ...
        {
            var expression = new CreateConstraintExpression(ConstraintType.PrimaryKey) { CheckIfExists = _context.CheckIfExists };
            _context.Expressions.Add(expression);
            return new CreateConstraintExpressionBuilder(expression);
        }
