	...
	public class MigrationVersionRunnerTests : IntegrationTestBase
	{
		...
		public void CanLoadMigrations()
		{
			ExecuteWithSupportedProcessors(processor =>
				{
					var runner = new MigrationVersionRunner(_conventions, processor, new MigrationLoader(_conventions), typeof(MigrationVersionRunnerTests).Assembly, typeof(TestMigration).Namespace, new Announcer(System.Console.Out));
		...
		{
			var runner = new MigrationVersionRunner(_conventions, processor, new MigrationLoader(_conventions), typeof(MigrationVersionRunnerTests).Assembly, @namespace, new Announcer(System.Console.Out));
			...
			ExecuteWithSupportedProcessors(processor =>
				{
					...
					var runner = new MigrationVersionRunner(_conventions, processor, new MigrationLoader(_conventions), typeof(MigrationVersionRunnerTests).Assembly, "FluentMigrator.Tests.Integration.Migrations.Interleaved.Pass3", new Announcer(System.Console.Out));
		...
		public void CanMigrateASpecificVersion()
		{
			ExecuteWithSupportedProcessors(processor =>
				{
					var runner = new MigrationVersionRunner(_conventions, processor, new MigrationLoader(_conventions), typeof(MigrationVersionRunnerTests).Assembly, "FluentMigrator.Tests.Integration.Migrations", new Announcer(System.Console.Out));
		...
		public void SqlServerMigrationsAreTransactional()
		{
			...
			var runner = new MigrationVersionRunner(_conventions, processor, new MigrationLoader(_conventions), typeof(MigrationVersionRunnerTests).Assembly, typeof(InvalidMigration).Namespace, new Announcer(System.Console.Out));
