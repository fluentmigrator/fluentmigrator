...
namespace FluentMigrator.Tests.Unit.Generators.Oracle
{
    public class OracleCreateTableTests : BaseTableCreateTests
    {
        ...
        public override void CanCreateTable()
        {
            ...
            sql.ShouldBe("CREATE TABLE TestTable1 (TestColumn1 NVARCHAR2(255), TestColumn2 NUMBER(10,0))");
        }
        ...
        public override void CanCreateTableWithPrimaryKey()
        {
            ...
            string sql = _generator.Generate(expression);
            sql.ShouldBe("CREATE TABLE TestTable1 (TestColumn1 NVARCHAR2(255), TestColumn2 NUMBER(10,0), PRIMARY KEY (TestColumn1))");
        }
        ...
        public override void CanCreateTableNamedPrimaryKey()
        {
            ...
            string sql = _generator.Generate(expression);
            sql.ShouldBe("CREATE TABLE TestTable1 (TestColumn1 NVARCHAR2(255), TestColumn2 NUMBER(10,0), CONSTRAINT TestKey PRIMARY KEY (TestColumn1))");
        }
        ...
        public override void CanCreateTableNamedMultiColumnPrimaryKey()
        {
            ...
            string sql = _generator.Generate(expression);
            sql.ShouldBe("CREATE TABLE TestTable1 (TestColumn1 NVARCHAR2(255), TestColumn2 NUMBER(10,0), CONSTRAINT TestKey PRIMARY KEY (TestColumn1, TestColumn2))");
        }
        ...
        public override void CanCreateTableWithDefaultValue()
        {
            ...
            sql.ShouldBe("CREATE TABLE TestTable1 (TestColumn1 NVARCHAR2(255) DEFAULT 'abc', TestColumn2 NUMBER(10,0))");
        }
        ...
        public override void CanCreateTableWithMultiColumnPrimaryKey()
        {
            ...
            sql.ShouldBe("CREATE TABLE TestTable1 (TestColumn1 NVARCHAR2(255), TestColumn2 NUMBER(10,0), PRIMARY KEY (TestColumn1, TestColumn2))");
        }
