...
{
    [TestFixture]
    public class PostgresBaseDescriptionGeneratorTests : BaseDescriptionGeneratorTests
    {
        [SetUp]
        public void Setup()
        {
            descriptionGenerator = new PostgresBaseDescriptionGenerator(new PostgresBaseQuoter());
        }
