...
namespace FluentMigrator.Tests.Unit.Expressions
{
    ...
    public class ExecuteEmbeddedSqlScriptExpressionTests
    {
        ...
        {
            var expression = new ExecuteEmbeddedSqlScriptExpression { SqlScript = testSqlScript, MigrationAssembly = new SingleAssembly(Assembly.GetExecutingAssembly()) };
        ...
        {
            var expression = new ExecuteEmbeddedSqlScriptExpression { SqlScript = testSqlScript.ToUpper(), MigrationAssembly = new SingleAssembly(Assembly.GetExecutingAssembly()) };
            var processor = new Mock<IMigrationProcessor>();
            processor.Setup(x => x.Execute(scriptContents)).Verifiable();
        ...
        {
            var expression = new ExecuteEmbeddedSqlScriptExpression { SqlScript = "InitialSchema.sql", MigrationAssembly = new SingleAssembly(Assembly.GetExecutingAssembly()) };
            var processor = new Mock<IMigrationProcessor>();
        ...
        {
            var expression = new ExecuteEmbeddedSqlScriptExpression { SqlScript = "FluentMigrator.Tests.EmbeddedResources.InitialSchema.sql", MigrationAssembly = new SingleAssembly(Assembly.GetExecutingAssembly()) };
            var processor = new Mock<IMigrationProcessor>();
            processor.Setup(x => x.Execute("InitialSchema")).Verifiable();
        ...
        {
            var expression = new ExecuteEmbeddedSqlScriptExpression { SqlScript = "NotUniqueResource.sql", MigrationAssembly = new SingleAssembly(Assembly.GetExecutingAssembly()) };
            var processor = new Mock<IMigrationProcessor>();
