...
{
    /// <summary>
    /// Locates connection strings by name in target config file or machine.config
    ...
    public class ConnectionStringManager
    {
        ...
        public ConnectionStringManager(string connection, string configPath, string target, string database)
        {
