...
{
    public class DotConnectPostgresProcessor : GenericProcessorBase
    {
        ...
        public DotConnectPostgresProcessor(IDbConnection connection, IMigrationGenerator generator, IAnnouncer announcer, IMigrationProcessorOptions options, IDbFactory factory)
