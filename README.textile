...
Profiles are used to selectively apply migrations depending on a command line option, or build script attribute. For instance, you may want to run Migrations 1,2 and 3 only in your Dev environment, and run Migration 4 in Production. Profiles will always be run if you pass them in the command line.
...
h2. Example usage of NAnt runner
